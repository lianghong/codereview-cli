...
class MoonshotProvider(TokenTrackingMixin, ModelProvider):
    ...
    def _create_model(self) -> Any:
        ...
        # ChatMoonshot extends BaseChatOpenAI, so the base class's routing
        # applies unchanged: tool-use when supported, otherwise the prompt-based
        # JSON path for models whose tool_choice conflicts with thinking mode
        # (kimi-k2.6).
